...
const type = "_doc";
const domain = process.env.OS_DOMAIN!; //"your-open-search-domain.com"; // the best way to get this value into your lambdas is to set it as an environment variable in CDK
